				...
				<nav>
					...
					<li><a href="/" class="{{ Request::is('/') ? 'active' : '' }}"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li>
							...
							<div id="utama" class="collapse in " aria-expanded="true" style="">
							  <ul class="nav">
								<li><a href="/transaksi" class="{{ Request::is('transaksi') ? 'active' : '' }}"> <span>Transaksi</span></a></li>
								<li><a href="/sewa" class="{{ Request::is('sewa') ? 'active' : '' }}"><span>Sewa</span></a></li>
							  </ul>
							</div>
						</li>
						
						<li>
							<a href="#referensi" data-toggle="collapse" class="{{ Request::is('kamar') || Request::is('penyewa') ? 'active' : '' }}" aria-expanded="true"><i class="lnr lnr-file-empty"></i> <span>Referensi</span> </a>
							<div id="referensi" class="collapse in" aria-expanded="true" style="">
								<ul class="nav">
